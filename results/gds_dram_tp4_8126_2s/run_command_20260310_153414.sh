...
# Generated: 2026-03-10 15:34:14
# To re-run this exact test configuration, execute:
#   bash run_command_20260310_153414.sh
# or
#   bash run_command_20260310_153414.sh --force-restart  # to restart from beginning
...
python working_set_tester.py \
  ...
  --output-tokens 1 \
  --output-dir results/gds_dram_tp4_8126_2s \
