...
# Generated: 2026-03-10 13:58:49
# To re-run this exact test configuration, execute:
#   bash run_command_20260310_135849.sh
# or
#   bash run_command_20260310_135849.sh --force-restart  # to restart from beginning
...
python working_set_tester.py \
  ...
  --output-tokens 1 \
  --max-ttft 5.0 \
  --output-dir results/dram_only_tp4_8125 \
