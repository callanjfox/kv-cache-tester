...
# Generated: 2026-03-11 02:39:18
# To re-run this exact test configuration, execute:
#   bash run_command_20260311_023918.sh
# or
#   bash run_command_20260311_023918.sh --force-restart  # to restart from beginning

python working_set_tester.py \
  --api-endpoint http://localhost:8125 \
  --context-sizes 128000 \
  --min-working-set-size 600000 \
  --max-working-set-size 5000000 \
  --working-set-increments 20 \
  --output-tokens 1 \
  --output-dir results/dram_only_tp4_8125_128k_2s \
