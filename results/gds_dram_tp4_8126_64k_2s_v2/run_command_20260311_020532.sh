...
# Generated: 2026-03-11 02:05:32
# To re-run this exact test configuration, execute:
#   bash run_command_20260311_020532.sh
# or
#   bash run_command_20260311_020532.sh --force-restart  # to restart from beginning
...
python working_set_tester.py \
  ...
  --output-tokens 1 \
  --output-dir results/gds_dram_tp4_8126_64k_2s_v2 \
